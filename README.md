...
| published \*         | Again pretty simple. To change the date format/locale, currently **en-GB**, update the date option in `src/site.config.ts`. Note you can also pass additional options to the component `<FormattedDate>` if required.                                                                                        |
| updated            | This is an optional date representing when a post has been updated, in the same format as the published.                                                                                                                                                                                                   |
...
| published \*         | ISO 8601 format with offsets allowed.              |
